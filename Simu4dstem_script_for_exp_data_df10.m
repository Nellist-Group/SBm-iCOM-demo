...
dataPath = '../binned_diff_20230819_163214_df10.hdf5'; % datapath for data file
...
imwrite(mat2gray(COM_result.COMxf),[save_img_path_4_epdp,'img_COMxf.png']);
imwrite(mat2gray(COM_result.COMyf),[save_img_path_4_epdp,'img_COMyf.png']);
imwrite(mat2gray(COM_result.COMxr),[save_img_path_4_epdp,'img_COMxr.png']);
imwrite(mat2gray(COM_result.COMyr),[save_img_path_4_epdp,'img_COMyr.png']);
...
%% manul aberration:
aberr_input = [ -7.506e-9;   % C1, in m
                1.132e-9;       % C12a, in m
                3.742e-9;       % C12b, in m
                58.832e-9;       % C23a, in m
                -101.071e-9;       % C23b, in m
                -212.065e-9;       % C21a, in m
                -64.422e-9;       % C21b, in m
                0.066e-6;       % C30a, in m
                7.255e-6;       % C34a, in m
                0.826e-6;       % C34b, in m
...
Res.COMxr = ptycho.COMxr;
Res.COMyr = ptycho.COMyr;
imwrite(mat2gray(Res.COMx),[save_img_path_4_epdp,'img_SBmCOMx.png']);
imwrite(mat2gray(Res.COMy),[save_img_path_4_epdp,'img_SBmCOMy.png']);
imwrite(mat2gray(Res.dCOM),[save_img_path_4_epdp,'img_SBmdCOM.png']);
imwrite(mat2gray(Res.iCOM),[save_img_path_4_epdp,'img_SBmiCOM.png']);
imwrite(mat2gray(Res.COMxr),[save_img_path_4_epdp,'img_SBmCOMxr.png']);
imwrite(mat2gray(Res.COMyr),[save_img_path_4_epdp,'img_SBmCOMyr.png']);
