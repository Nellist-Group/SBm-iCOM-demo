function [ptycho] = define_probe_function_Modified2(ptycho)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
% this function needs comments
% change abeeration notations, use JEOL form and CEOS notation
...
% probe function
% chi function
func_aber = FuncAberrUV2(ptycho.Kx_wp,ptycho.Ky_wp,aberr_input);
