function [ptycho_0,Res] = Simu4dstem_cal_WDD_deconv_iCOM(jsonData,dps_4d)
...
% parameters change
ptycho.identifier = 'Simu4dstem_cal_WDD';
...
[ptycho] = wigner_distribution_deconvolution_reconstruction_iCOM(ptycho);
...
if jsonData.spot_size_A > 0
    Res.wdd = Simu4dstem_spot_size_conv(Res.wdd,jsonData.step_size,jsonData.spot_size_A);
end
